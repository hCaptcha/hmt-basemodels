...
# class TestSchematicsRequesterRestrictedAnswerSet(unittest.TestCase):
#     """
#     Test validation code for the restricted answer set using schematics.
#     """
#
#     def test_ilmc_validate_rsa_valid(self):
#         """
#         Test that validation passes when restricted answer has two options.
#         """
#
#         data = MANIFEST_VALUES.copy()
#         data["requester_restricted_answer_set"] = {"one": {"en": "one"}, "two": {"en": "two"}}
#
#         m = basemodels.Manifest(data)
#         m.validate()
#
#     def test_ilmc_validate_rsa_invalid(self):
#         """
#         Test that validation fails when restricted answer has one option.
#         """
#
#         data = MANIFEST_VALUES.copy()
#         data["requester_restricted_answer_set"] = {"one": {"en": "one"}}
#
#         m = basemodels.Manifest(data)
#         with self.assertRaises(DataError):
#             m.validate()
#
#     def test_ilmc_validate_rsa_invalid2(self):
#         """
#         Test that validation fails when restricted answer has five options.
#         """
#
#         data = MANIFEST_VALUES.copy()
#         data["requester_restricted_answer_set"] = {"one": {"en": "one"}, "two": {"en": "two"}, "three": {"en": "three"},
#                                                    "four": {"en": "four"}, "five": {"en": "five"}}
#
#         m = basemodels.Manifest(data)
#         with self.assertRaises(DataError):
#             m.validate()
#
#
# class TestPydanticRequesterRestrictedAnswerSet(unittest.TestCase):
#
#     def test_ilmc_validate_rsa_valid(self):
#         """
#         Test that validation passes when restricted answer has two options.
